...
3. `LESSON-CLOSEOUT.md`: finding dispositions and completion gate
4. `PANGRAM-ACTIONS-RUNBOOK.md`: repository-secret detector route
5. `../state/CURRENT-STATE.md`: recovery checkpoint
