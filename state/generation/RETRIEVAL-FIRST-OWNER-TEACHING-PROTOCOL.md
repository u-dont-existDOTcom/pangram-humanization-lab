...
- names or personal facts;
- jokes/catchphrases;
- distinctive wording merely because it appeared in a successful example;
- factual claims from another topic;
- punctuation/errors/slang as camouflage.
...
- a competent cold read is genuinely uncertain whether the passage remains AI-shaped;
- an exact controlled experiment needs a detector outcome to distinguish hypotheses;
- a production boundary requires detector certification under a current owner/task contract.
